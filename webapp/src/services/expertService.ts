...
let expertSourceMode: 'api' | 'local' = 'local';

// 初始化专家数据（同步，用于本地硬编码数据）
...
// 异步初始化：优先从 API 加载，失败回退到本地硬编码
export async function initExpertsFromApi(): Promise<void> {
  try {
    const response = await fetch('/api/v1/expert-library/experts/full');
    if (response.ok) {
      const data = await response.json();
      if (data.experts?.length > 0) {
        expertsCache = data.experts;
        expertSourceMode = 'api';
        initExpertEmbeddings(expertsCache);
        console.log(`[ExpertService] Loaded ${data.experts.length} experts from API`);
        return;
      }
    }
  } catch {
  ...
  expertSourceMode = 'local';
  console.log(`[ExpertService] Using local hardcoded data (${expertsCache.length} experts)`);
}

// 获取数据源模式
export function getExpertSourceMode(): 'api' | 'local' {
  return expertSourceMode;
}
...
function extractDomainFromTopic(topic: string, industry?: string): string {
  const domainKeywords: Record<string, string[]> = {
    ...
    E08: ['房地产', '地产', '住宅', '商业', '物业', '租赁', '惠居', '长租', '住房租赁'],
    E09: ['文化', '传媒', '内容', '娱乐', '影视'],
    E10: ['制造', '工业', '自动化', '工艺', '质量'],
...
export function loadExpertsData(): Expert[] {
  return [
    ...
    },
    {
      ...
      domainName: '特级专家',
      profile: {
        title: 'Tesla/SpaceX CEO · 战略视野',
        background: '同 S-03，但侧重创业战略与组织管理视角：从 0 到 1 的技术公司如何建立难以复制的竞争壁垒。',
        personality: '激进布局，垂直整合，用工程逻辑推导战略',
      },
      philosophy: {
        core: ['垂直整合', '组织密度', '使命驱动', '极限测试'],
        quotes: ['第一名和第二名的差距，比第二名和第一百名的差距还要大', '快速失败，学到教训，再试一次'],
      },
      achievements: [
        { title: '星舰全栈自研', description: '发动机到整流罩全部自制', date: '2022', impact: '垂直整合的极致案例' },
        { title: 'Tesla FSD', description: '端到端神经网络自动驾驶', date: '2023', impact: '软件定义汽车的战略布局' },
        { title: 'X收购与重组', description: '大刀阔斧削减人员提升效率', date: '2022', impact: '重新定义科技公司运营密度' },
      ],
      reviewDimensions: ['战略壁垒', '垂直整合深度', '执行速度', '技术自主性'],
      status: 'active',
      totalReviews: 89,
      acceptanceRate: 0.86,
      avgResponseTime: 7,
    ...
    },
    {
      ...
      profile: {
        title: '阿里巴巴前CEO',
        background: '阿里巴巴前CEO，双十一缔造者，主导阿里云、菜鸟、盒马等新零售战略布局。组织架构管理大师。',
        personality: '战略清晰，组织变革，追求商业模式创新',
      },
      philosophy: {
        core: ['在线化', '数字化', '智能化', '组织弹性'],
        quotes: ['没有成功的企业，只有时代的企业', '双十一是一场消费者洞察实验'],
      },
      achievements: [
        { title: '双十一商业化', description: '从促销节到全球购物节', date: '2009-2020', impact: '重塑零售行业消费节点' },
        { title: '阿里云战略', description: '推动阿里云成为中国第一云', date: '2015-2022', impact: '中国云计算格局奠定' },
        { title: '阿里1+6+N拆分', description: '大象起舞的组织创新', date: '2023', impact: '巨头组织弹性化探索' },
      ],
      reviewDimensions: ['商业模式创新', '组织效能', '数字化转型', '平台生态'],
      status: 'active',
      totalReviews: 103,
      acceptanceRate: 0.87,
      avgResponseTime: 9,
    ...
    },
    {
      ...
      profile: {
        title: '美团联合创始人',
        background: '美团联合创始人，历任多个核心业务负责人。互联网老兵，竞争策略专家，以极致执行力著称。',
        personality: '务实，执行力强，善于竞争格局分析，直指本质',
      },
      philosophy: {
        core: ['极致执行', '竞争策略', '供给侧思维', '数据驱动'],
        quotes: ['竞争的本质是资源分配效率', '执行力就是把战略变成现实的能力'],
      },
      achievements: [
        { title: '外卖业务', description: '主导美团外卖击败饿了么', date: '2013-2018', impact: '建立外卖行业壁垒' },
        { title: '酒旅业务', description: '推动美团酒旅超越携程', date: '2016', impact: '重塑在线旅游格局' },
        { title: '光年之外', description: '创立 AI 大模型创业公司', date: '2023', impact: 'LLM领域的新探索' },
      ],
      reviewDimensions: ['竞争策略', '执行效率', '供给侧优化', '市场洞察'],
      status: 'active',
      totalReviews: 87,
      acceptanceRate: 0.88,
      avgResponseTime: 8,
    ...
    },
    {
      ...
      profile: {
        title: 'AI战略家 · 奇绩创坛创始人',
        background: '微软全球执行副总裁、百度COO、YC中国CEO，现任奇绩创坛CEO。横跨硅谷与中国的顶级AI战略家。',
        personality: '全局视野，技术+商业双轨，AI长期主义者',
      },
      philosophy: {
        core: ['AI平台化', '技术商业化', '创业生态', '长期主义'],
        quotes: ['AI是这个时代最重要的技术革命', '中国AI创业需要找到独特的落地场景'],
      },
      achievements: [
        { title: '微软Bing改造', description: '主导搜索业务全球战略', date: '2008-2016', impact: '奠定微软AI基础' },
        { title: '百度AI布局', description: '主导百度AI战略转型', date: '2017-2018', impact: '加速中国AI产业化' },
        { title: '奇绩创坛', description: '打造中国顶级早期孵化器', date: '2019-至今', impact: '投资100+AI创业团队' },
      ],
      reviewDimensions: ['AI战略', '技术落地', '创业生态', '全球视野'],
      status: 'active',
      totalReviews: 76,
      acceptanceRate: 0.89,
      avgResponseTime: 8,
    ...
    // ==================== E01: 宏观经济 (新增3位) ====================
    {
      ...
      domainCode: 'E01',
      domainName: '宏观经济',
      profile: { title: '国家金融与发展实验室理事长', background: '中国社科院原副院长，著名金融学家，长期从事宏观金融研究', personality: '学术严谨，政策洞察力强' },
      philosophy: { core: ['金融发展', '宏观审慎', '债务管理'], quotes: ['金融是实体经济的血脉'] },
      achievements: [{ title: '国家资产负债表研究', description: '构建中国国家资产负债表', date: '2012', impact: '开创宏观金融新领域' }],
      reviewDimensions: ['金融稳定', '债务风险', '政策协调'],
      status: 'active', totalReviews: 198, acceptanceRate: 0.92, avgResponseTime: 8,
    },
    {
      id: 'E01-08',
      name: '高善文',
      ...
      domainCode: 'E01',
      domainName: '宏观经济',
      profile: { title: '安信证券首席经济学家', background: '北大博士，原央行货币政策委员会专家委员，专注宏观与资本市场研究', personality: '独立思考，观点鲜明' },
      philosophy: { core: ['经济周期', '资产配置', '市场出清'], quotes: ['要做有原则的实用主义者'] },
      achievements: [{ title: '资产重估理论', description: '提出资产重估理论框架', date: '2006', impact: '影响市场分析框架' }],
      reviewDimensions: ['周期判断', '资产配置', '市场趋势'],
      status: 'active', totalReviews: 245, acceptanceRate: 0.88, avgResponseTime: 6,
    },
    {
      id: 'E01-09',
      name: '鲁政委',
      ...
      domainCode: 'E01',
      domainName: '宏观经济',
      profile: { title: '兴业银行首席经济学家', background: '经济学博士，专注汇率、利率与宏观经济政策研究', personality: '数据驱动，逻辑严密' },
      philosophy: { core: ['汇率研究', '政策跟踪', '数据分析'], quotes: ['数据是宏观研究的基石'] },
      achievements: [{ title: '汇率预测', description: '多次准确预测汇率走势', date: '2015', impact: '指导企业汇率避险' }],
      reviewDimensions: ['汇率分析', '利率趋势', '政策预判'],
      status: 'active', totalReviews: 167, acceptanceRate: 0.86, avgResponseTime: 7,
    },
    // ==================== E01: 宏观经济 (6位) ====================
    {
      id: 'E01-01',
    ...
    // ==================== E02: 金融科技 (新增3位) ====================
    {
      ...
      domainCode: 'E02',
      domainName: '金融科技',
      profile: { title: '宜信公司创始人', background: '北京大学数学系毕业，美国南方大学硕士，中国普惠金融和财富管理行业开拓者', personality: '前瞻性思考，长期主义' },
      philosophy: { core: ['普惠金融', '财富管理', '科技赋能'], quotes: ['让更多人享受金融服务'] },
      achievements: [{ title: '宜信创立', description: '创立宜信公司', date: '2006', impact: '开创中国P2P行业' }],
      reviewDimensions: ['风控体系', '普惠价值', '科技应用'],
      status: 'active', totalReviews: 178, acceptanceRate: 0.85, avgResponseTime: 7,
    },
    {
      id: 'E02-08',
      name: '叶大清',
      ...
      domainCode: 'E02',
      domainName: '金融科技',
      profile: { title: '融360联合创始人', background: '前美国运通、PayPal高管，金融搜索和比较平台开创者', personality: '用户导向，数据驱动' },
      philosophy: { core: ['金融搜索', '用户教育', '透明比较'], quotes: ['让金融更简单'] },
      achievements: [{ title: '融360上市', description: '纽交所上市', date: '2017', impact: '金融搜索第一股' }],
      reviewDimensions: ['用户体验', '产品设计', '数据风控'],
      status: 'active', totalReviews: 156, acceptanceRate: 0.84, avgResponseTime: 6,
    },
    {
      id: 'E02-09',
      name: '计葵生',
      ...
      domainCode: 'E02',
      domainName: '金融科技',
      profile: { title: '陆金所原董事长', background: '前麦肯锡全球资深合伙人，陆金所创始CEO，金融科技平台搭建者', personality: '国际化视野，战略思维' },
      philosophy: { core: ['平台模式', '风险管理', '资产配置'], quotes: ['科技让财富管理更普惠'] },
      achievements: [{ title: '陆金所创立', description: '创立陆金所平台', date: '2011', impact: '开创互联网财富管理平台' }],
      reviewDimensions: ['平台运营', '风控能力', '资产质量'],
      status: 'active', totalReviews: 145, acceptanceRate: 0.87, avgResponseTime: 8,
    },
    // ==================== E02: 金融科技 (6位) ====================
    {
      id: 'E02-01',
    ...
    // ==================== E03: 新能源 (新增3位) ====================
    {
      ...
      domainCode: 'E03',
      domainName: '新能源',
      profile: { title: '宁德时代董事长', background: '中科院物理所博士，宁德时代创始人，全球动力电池龙头掌舵人', personality: '技术狂，快速决策' },
      philosophy: { core: ['技术创新', '极限制造', '快速迭代'], quotes: ['Innovation drives the future'] },
      achievements: [{ title: '宁德时代上市', description: '创业板上市', date: '2018', impact: '成为全球动力电池第一' }],
      reviewDimensions: ['技术路线', '产能规模', '成本控制'],
      status: 'active', totalReviews: 234, acceptanceRate: 0.91, avgResponseTime: 5,
    },
    {
      id: 'E03-08',
      name: '刘汉元',
      ...
      domainCode: 'E03',
      domainName: '新能源',
      profile: { title: '通威集团董事局主席', background: '从水产饲料大王到光伏硅料龙头，永祥股份创始人', personality: '实业家，成本控制大师' },
      philosophy: { core: ['成本控制', '垂直整合', '效率优先'], quotes: ['做好每一个环节的成本控制'] },
      achievements: [{ title: '通威光伏崛起', description: '成为全球硅料龙头', date: '2020', impact: '改变光伏产业格局' }],
      reviewDimensions: ['成本竞争力', '规模效应', '供应链管理'],
    ...
    },
    {
      ...
      domainCode: 'E03',
      domainName: '新能源',
      profile: { title: '天合光能董事长', background: '吉林大学硕士，天合光能创始人，光伏组件龙头企业掌舵人', personality: '全球化视野，长期主义' },
      philosophy: { core: ['全球布局', '技术创新', '可持续发展'], quotes: ['太阳能造福全人类'] },
      achievements: [{ title: '天合光能上市', description: '科创板上市', date: '2020', impact: '光伏组件全球领先' }],
      reviewDimensions: ['全球市占率', '技术先进性', 'ESG表现'],
    ...
    // ==================== E04: 医疗健康 (新增3位) ====================
    {
      ...
      domainCode: 'E04',
      domainName: '医疗健康',
      profile: { title: '药明康德董事长', background: '北京大学化学系毕业，哥伦比亚大学博士，CRO行业开创者', personality: '科学家气质，商业头脑' },
      philosophy: { core: ['医药研发', '平台服务', '全球化'], quotes: ['让天下没有难做的药'] },
      achievements: [{ title: '药明康德上市', description: 'A+H股上市', date: '2018', impact: '成为全球CRO龙头' }],
      reviewDimensions: ['研发能力', '客户质量', '平台规模'],
      status: 'active', totalReviews: 267, acceptanceRate: 0.92, avgResponseTime: 6,
    },
    {
      id: 'E04-08',
      name: '钟睒睒',
      ...
      domainCode: 'E04',
      domainName: '医疗健康',
      profile: { title: '农夫山泉/万泰生物董事长', background: '从记者到企业家，农夫山泉和万泰生物双料首富', personality: '低调务实，营销大师' },
      philosophy: { core: ['产品力', '健康理念', '长期主义'], quotes: ['我们不生产水，我们只是大自然的搬运工'] },
      achievements: [{ title: 'HPV疫苗', description: '国产HPV疫苗获批', date: '2019', impact: '打破进口垄断' }],
      reviewDimensions: ['产品竞争力', '品牌价值', '渠道能力'],
      status: 'active', totalReviews: 198, acceptanceRate: 0.89, avgResponseTime: 8,
    },
    {
      id: 'E04-09',
      name: '孙飘扬',
      ...
      domainCode: 'E04',
      domainName: '医疗健康',
      profile: { title: '恒瑞医药董事长', background: '中国药科大学毕业，从技术员到恒瑞掌舵人，中国创新药领军人物', personality: '技术出身，创新导向' },
      philosophy: { core: ['创新药研发', '国际化', '质量至上'], quotes: ['要做就做首仿和原创'] },
      achievements: [{ title: '恒瑞创新转型', description: '从仿制药到创新药', date: '2015', impact: '中国创新药标杆' }],
      reviewDimensions: ['研发管线', '创新能力', '国际化程度'],
      status: 'active', totalReviews: 245, acceptanceRate: 0.90, avgResponseTime: 7,
    },
    // ==================== E04: 医疗健康 (6位) ====================
    {
      id: 'E04-01',
    ...
    },
    {
      ...
      domainName: '房地产',
      profile: {
        title: '产业战略与经营分析专家（居住服务）',
        background:
          '赵一濛。历任字节跳动产品总监、滴滴高级产品专家、美团产品与管理负责人；贝壳 CEO-office 深度参与新租赁与家庭服务从 0 到规模化，惠居「美租」方向聚焦标准化产品、整装升级与 UE/P&L 一体化经营体系。此前亦有大型基建与能源企业经历。擅长把复杂产业问题拆成可验证的战役假设、UE 弹性与组织对齐。',
        personality: '少说多做、先事实后结论；追问指标与财务硬账，强调假设验证与 PMO 节奏',
      },
      philosophy: {
        core: [
          '假设验证与 PMF',
          'UE（单位经济）与 P&L 递归对齐',
          '标品化、整装化与交付确定性',
          '分层治理：战略损益倒推 / 盯住 UE 验证 / 执行层工具赋能',
        ],
        quotes: [
          '先把测什么、对照是什么讲清楚，再谈规模化',
          '线下重交付不必追求全量过程监控，锚定财务与物权交割等硬边界更稳',
        ],
      },
      achievements: [
        {
          title: '美租 UE 与经营分析体系',
          description: '推动标品占比与整装能力假设验证，构建 L3/L2/L1 分层治理与 UE 管理闭环',
          date: '2025-2026',
          impact: '战略决策有统一语言与工具，减少指标博弈与无效数字化',
        },
        {
          title: '新租赁供给侧研判',
          description: '基于核心城市供给机构化率与包租、装配、服务配置等要素拆解市场战役',
          date: '2024-2025',
          impact: '把供需矛盾表述为可落地的业务目标与协同路径',
        },
      ],
      reviewDimensions: [
        '战略假设与 PMF',
    ...
    // ==================== E05: 消费零售 (新增3位) ====================
    {
      ...
      domainCode: 'E05',
      domainName: '消费零售',
      profile: { title: '名创优品创始人', background: '从化妆品销售到零售巨头，名创优品全球超5000家门店', personality: '产品偏执狂，效率至上' },
      philosophy: { core: ['产品为王', '高性价比', '快速上新'], quotes: ['优质低价是永恒的商业模式'] },
      achievements: [{ title: '名创优品上市', description: '纽交所上市', date: '2020', impact: '新零售全球化标杆' }],
      reviewDimensions: ['产品能力', '供应链效率', '门店扩张'],
      status: 'active', totalReviews: 234, acceptanceRate: 0.86, avgResponseTime: 6,
    },
    {
      id: 'E05-07',
      name: '王岑',
      ...
      domainCode: 'E05',
      domainName: '消费零售',
      profile: { title: '消费投资专家', background: '天图资本原合伙人，专注消费投资15年，投资周黑鸭、百果园等', personality: '消费洞察敏锐，实战派' },
      philosophy: { core: ['消费洞察', '品牌打造', '渠道为王'], quotes: ['消费品要做时间的朋友'] },
      achievements: [{ title: '投资周黑鸭', description: '早期投资周黑鸭', date: '2010', impact: '获得数十倍回报' }],
      reviewDimensions: ['消费趋势', '品牌定位', '渠道策略'],
    ...
    },
    {
      ...
      domainCode: 'E05',
      domainName: '消费零售',
      profile: { title: '分众传媒董事长', background: '华东师范大学毕业，分众传媒创始人，电梯媒体开创者', personality: '营销大师，战略思维' },
      philosophy: { core: ['品牌定位', '饱和攻击', '心智占领'], quotes: ['品牌是人心的算法'] },
      achievements: [{ title: '分众传媒上市', description: '纳斯达克上市', date: '2005', impact: '开创电梯媒体品类' }],
      reviewDimensions: ['品牌策略', '营销效果', '媒体价值'],
      status: 'active', totalReviews: 312, acceptanceRate: 0.89, avgResponseTime: 5,
    },
    // ==================== E05: 消费零售 (5位) ====================
    {
      id: 'E05-01',
    ...
    // ==================== E06: 半导体 (新增3位) ====================
    {
      ...
      domainCode: 'E06',
      domainName: '半导体',
      profile: { title: '台积电创始人', background: 'MIT博士，德州仪器工作20年，台积电创始人，晶圆代工模式开创者', personality: '战略眼光，长期主义' },
      philosophy: { core: ['专业分工', '技术领先', '客户信任'], quotes: ['台积电是大家的代工厂'] },
      achievements: [{ title: '台积电创立', description: '创立台积电', date: '1987', impact: '开创晶圆代工行业' }],
      reviewDimensions: ['技术领先性', '产能规模', '客户结构'],
      status: 'active', totalReviews: 456, acceptanceRate: 0.95, avgResponseTime: 8,
    },
    {
      id: 'E06-08',
      name: '梁孟松',
      ...
      domainCode: 'E06',
      domainName: '半导体',
      profile: { title: '中芯国际联合CEO', background: 'UC Berkeley博士，台积电、三星研发高管，先进制程技术专家', personality: '技术天才，专注研发' },
      philosophy: { core: ['技术突破', '先进制程', '追赶战略'], quotes: ['技术是半导体企业的生命线'] },
      achievements: [{ title: '中芯N+1工艺', description: '突破先进制程', date: '2020', impact: '缩小与国际差距' }],
      reviewDimensions: ['技术能力', '制程先进性', '研发投入'],
      status: 'active', totalReviews: 234, acceptanceRate: 0.91, avgResponseTime: 7,
    },
    {
      id: 'E06-09',
      name: '虞仁荣',
      ...
      domainCode: 'E06',
      domainName: '半导体',
      profile: { title: '韦尔股份董事长', background: '清华大学EE系毕业，韦尔股份创始人，CIS芯片龙头掌舵人', personality: '并购整合高手，战略眼光' },
      philosophy: { core: ['并购整合', '技术积累', '市场拓展'], quotes: ['通过并购实现跨越式发展'] },
      achievements: [{ title: '收购豪威科技', description: '收购豪威科技', date: '2019', impact: '成为全球CIS第三' }],
      reviewDimensions: ['技术整合', '市场份额', '产品线'],
      status: 'active', totalReviews: 167, acceptanceRate: 0.86, avgResponseTime: 8,
    },
    // ==================== E06: 半导体 (6位) ====================
    {
    ...
    // ==================== E07: 人工智能 (新增3位) ====================
    {
      ...
      domainCode: 'E07',
      domainName: '人工智能',
      profile: { title: 'Landing AI创始人', background: '斯坦福教授，Google Brain联合创始人，Coursera联合创始人，AI教育布道者', personality: '教育情怀，技术乐观主义' },
      philosophy: { core: ['AI民主化', '教育普惠', '技术落地'], quotes: ['AI是新的电力'] },
      achievements: [{ title: 'Google Brain', description: '创立Google Brain', date: '2011', impact: '推动深度学习革命' }],
      reviewDimensions: ['技术先进性', '落地应用', '教育价值'],
      status: 'active', totalReviews: 389, acceptanceRate: 0.94, avgResponseTime: 6,
    },
    {
      id: 'E07-08',
      name: '颜水成',
      ...
      domainCode: 'E07',
      domainName: '人工智能',
      profile: { title: 'Sea集团首席科学家', background: '北大博士，前360集团首席科学家，计算机视觉专家，IEEE Fellow', personality: '学术严谨，工程实践' },
      philosophy: { core: ['计算机视觉', '产学研结合', '技术落地'], quotes: ['好的研究要服务于实际应用'] },
      achievements: [{ title: '360 AI研究院', description: '创立360AI研究院', date: '2015', impact: '推动AI产业化' }],
      reviewDimensions: ['视觉技术', '算法效率', '产品落地'],
      status: 'active', totalReviews: 245, acceptanceRate: 0.89, avgResponseTime: 7,
    },
    {
      id: 'E07-09',
      name: '周靖人',
      ...
      domainCode: 'E07',
      domainName: '人工智能',
      profile: { title: '阿里云智能CTO', background: '哥伦比亚大学博士，前微软研发高管，阿里云技术掌舵人', personality: '技术战略思维，云原生' },
      philosophy: { core: ['云原生AI', '大模型', '技术普惠'], quotes: ['AI是云的新篇章'] },
      achievements: [{ title: '通义千问', description: '推出通义千问大模型', date: '2023', impact: '国产大模型领先' }],
      reviewDimensions: ['大模型能力', '云AI融合', '技术架构'],
    ...
    },
    {
      ...
      profile: {
        title: '人工智能方向专家',
        background: '聚焦大模型与机器学习、AI工程化、智能体与产业落地。强调可复现评测、数据与系统可靠性、成本与安全边界。',
        personality: '机制优先，指标说话，工程务实',
      },
      philosophy: { core: ['任务形式化', '基线与对照', '数据飞轮', '可观测与可回滚'], quotes: ['先定义测什么，再谈模型多强', '没有对照的改进都是幻觉'] },
      achievements: [{ title: 'AI产业化方法论', description: '推动从演示到生产的闭环实践', date: '2024', impact: '提升AI项目可交付性' }],
      reviewDimensions: ['任务与指标', '评测可信度', '数据与系统', '安全合规', '成本延迟'],
      status: 'active', totalReviews: 0, acceptanceRate: 0.90, avgResponseTime: 8,
      angle: 'challenger',
    },
    // ==================== E07: 人工智能 (6位) ====================
    {
    ...
    // ==================== E08: 房地产 (新增3位) ====================
    {
      ...
      domainCode: 'E08',
      domainName: '房地产',
      profile: { title: '龙湖集团创始人', background: '西北工业大学毕业，龙湖地产创始人，中国女首富，品质地产代表', personality: '品质至上，稳健经营' },
      philosophy: { core: ['产品品质', '稳健财务', '长期主义'], quotes: ['善待你一生'] },
      achievements: [{ title: '龙湖物业', description: '龙湖物业上市', date: '2018', impact: '物业服务标杆' }],
      reviewDimensions: ['产品品质', '财务稳健', '运营能力'],
      status: 'active', totalReviews: 267, acceptanceRate: 0.91, avgResponseTime: 7,
    },
    {
      id: 'E08-07',
      name: '林中',
      ...
      domainCode: 'E08',
      domainName: '房地产',
      profile: { title: '旭辉控股董事长', background: '厦门大学EMBA，旭辉集团创始人，闽系房企代表', personality: '战略清晰，管理精细' },
      philosophy: { core: ['稳健经营', '管理红利', '全国化布局'], quotes: ['做透一座城，再做下一城'] },
      achievements: [{ title: '旭辉上市', description: '香港上市', date: '2012', impact: '进入第一梯队' }],
      reviewDimensions: ['拿地策略', '产品力', '财务安全'],
      status: 'active', totalReviews: 189, acceptanceRate: 0.86, avgResponseTime: 8,
    },
    {
      id: 'E08-08',
      name: '左晖',
      ...
      domainCode: 'E08',
      domainName: '房地产',
      profile: { title: '链家/贝壳创始人', background: '北京化工大学毕业，链家、贝壳找房创始人，房产中介行业颠覆者', personality: '长期主义，做难而正确的事' },
      philosophy: { core: ['真房源', '服务品质', '平台化'], quotes: ['做难而正确的事'] },
      achievements: [{ title: '贝壳上市', description: '纽交所上市', date: '2020', impact: '房产交易第一股' }],
    ...
    // ==================== E09: 文化传媒 (新增3位) ====================
    {
      ...
      domainCode: 'E09',
      domainName: '文化传媒',
      profile: { title: 'B站董事长', background: '成都信息工程大学毕业，金山前高管，B站董事长兼CEO', personality: '理性冷静，社区信仰' },
      philosophy: { core: ['社区价值', '内容生态', 'Z世代'], quotes: ['B站是 content community'] },
      achievements: [{ title: 'B站上市', description: '纳斯达克上市', date: '2018', impact: '年轻人文化第一股' }],
      reviewDimensions: ['社区粘性', '内容质量', '商业化'],
      status: 'active', totalReviews: 289, acceptanceRate: 0.88, avgResponseTime: 6,
    },
    {
      id: 'E09-07',
      name: '龚宇',
      ...
      domainCode: 'E09',
      domainName: '文化传媒',
      profile: { title: '爱奇艺创始人', background: '清华博士，前搜狐COO，爱奇艺创始人，长视频行业开拓者', personality: '技术背景，内容战略' },
      philosophy: { core: ['原创内容', '会员模式', '技术驱动'], quotes: ['做一家以科技创新为驱动的伟大娱乐公司'] },
      achievements: [{ title: '爱奇艺上市', description: '纳斯达克上市', date: '2018', impact: '长视频第一股' }],
      reviewDimensions: ['内容质量', '会员增长', '成本控制'],
      status: 'active', totalReviews: 245, acceptanceRate: 0.85, avgResponseTime: 7,
    },
    {
      id: 'E09-08',
      name: '樊路远',
      ...
      domainCode: 'E09',
      domainName: '文化传媒',
      profile: { title: '阿里影业董事长', background: '前支付宝副总裁，阿里大文娱掌舵人，阿里影业、优酷负责人', personality: '互联网背景，生态思维' },
      philosophy: { core: ['生态协同', '数据驱动', 'IP运营'], quotes: ['内容产业需要耐心和长期投入'] },
      achievements: [{ title: '淘票票', description: '打造淘票票平台', date: '2015', impact: '改变电影票务格局' }],
    ...
    // ==================== E10: 先进制造 (新增3位) ====================
    {
      ...
      domainCode: 'E10',
      domainName: '先进制造',
      profile: { title: '山东重工董事长', background: '潍柴动力董事长，山东重工集团掌舵人，国企改革和国际化代表', personality: '铁腕管理，国际化视野' },
      philosophy: { core: ['技术突破', '全球并购', '管理变革'], quotes: ['一天当两天半用'] },
      achievements: [{ title: '收购凯傲', description: '收购德国凯傲集团', date: '2012', impact: '中国叉车全球第一' }],
      reviewDimensions: ['技术实力', '全球布局', '管理效率'],
      status: 'active', totalReviews: 198, acceptanceRate: 0.87, avgResponseTime: 7,
    },
    {
      id: 'E10-07',
      ...
      domainCode: 'E10',
      domainName: '先进制造',
      profile: { title: '柳工集团董事长', background: '华科大毕业，柳工集团掌舵人，中国工程机械行业领军人物', personality: '国际化，创新驱动' },
      philosophy: { core: ['国际化', '产品创新', '客户导向'], quotes: ['制造业要走出去'] },
      achievements: [{ title: '柳工国际化', description: '海外收入占比超50%', date: '2018', impact: '中国制造出海标杆' }],
      reviewDimensions: ['海外占比', '产品创新', '品牌影响力'],
      status: 'active', totalReviews: 156, acceptanceRate: 0.85, avgResponseTime: 8,
    },
    {
      id: 'E10-08',
      ...
      domainCode: 'E10',
      domainName: '先进制造',
      profile: { title: '波司登董事长', background: '从村办缝纫组到羽绒服龙头，波司登创始人，品牌升级代表', personality: '工匠精神，品牌情怀' },
      philosophy: { core: ['品牌升级', '产品创新', '渠道变革'], quotes: ['一辈子只做羽绒服'] },
      achievements: [{ title: '波司登升级', description: '品牌年轻化升级', date: '2018', impact: '重新成为年轻人首选' }],
      reviewDimensions: ['品牌力', '产品力', '渠道效率'],
      status: 'active', totalReviews: 145, acceptanceRate: 0.86, avgResponseTime: 9,
    },
    // ==================== E10: 先进制造 (5位) ====================
    {
      id: 'E10-01',
    ...
    // ==================== E11: ESG可持续 (新增3位) ====================
    {
      ...
      domainCode: 'E11',
      domainName: 'ESG可持续',
      profile: { title: '北京绿色金融与可持续发展研究院院长', background: '前央行货币政策委员会委员，绿色金融研究专家，G20可持续金融工作组共同主席', personality: '政策研究，国际视野' },
      philosophy: { core: ['绿色金融', '碳中和', '可持续投资'], quotes: ['绿色金融是实现碳中和的关键'] },
      achievements: [{ title: '绿色金融路线图', description: '发布中国绿色金融路线图', date: '2015', impact: '推动绿色金融发展' }],
      reviewDimensions: ['绿色金融', '政策影响', '国际协调'],
      status: 'active', totalReviews: 178, acceptanceRate: 0.90, avgResponseTime: 8,
    },
    {
      id: 'E11-07',
      name: '张希良',
      ...
      domainCode: 'E11',
      domainName: 'ESG可持续',
      profile: { title: '清华大学能源环境经济研究所所长', background: '清华教授，全国碳排放交易体系总体设计技术专家负责人', personality: '学术研究，政策参与' },
      philosophy: { core: ['碳市场', '能源转型', '气候政策'], quotes: ['碳市场是最低成本减排工具'] },
      achievements: [{ title: '全国碳市场', description: '参与设计全国碳市场', date: '2021', impact: '全球最大碳市场启动' }],
      reviewDimensions: ['碳市场设计', '能源转型', '政策建议'],
      status: 'active', totalReviews: 134, acceptanceRate: 0.91, avgResponseTime: 9,
    },
    {
      id: 'E11-08',
      name: '龙平芳',
      ...
      domainCode: 'E11',
      domainName: 'ESG可持续',
      profile: { title: '盟浪可持续数字科技CEO', background: '前社投盟秘书长，中国ESG评级和数据服务开拓者', personality: '数据驱动，标准建设' },
      philosophy: { core: ['ESG评级', '数据科技', '影响力投资'], quotes: ['用科技赋能可持续发展'] },
      achievements: [{ title: '义利99', description: '发布义利99榜单', date: '2016', impact: '中国ESG投资标杆' }],
      reviewDimensions: ['ESG评级', '数据质量', '投资应用'],
      status: 'active', totalReviews: 112, acceptanceRate: 0.85, avgResponseTime: 7,
    },
    // ==================== E11: ESG可持续 (5位) ====================
    {
      id: 'E11-01',
    ...
    // ==================== E12: 跨境出海 (新增3位) ====================
    {
      ...
      domainCode: 'E12',
      domainName: '跨境出海',
      profile: { title: '安克创新创始人', background: '北大学霸，Google前工程师，安克创新创始人，跨境电商品牌出海标杆', personality: '产品驱动，品牌思维' },
      philosophy: { core: ['产品主义', '品牌出海', '用户价值'], quotes: ['创造价值者胜利'] },
      achievements: [{ title: '安克上市', description: '创业板上市', date: '2020', impact: '跨境电商品牌第一股' }],
      reviewDimensions: ['产品力', '品牌认知', '渠道布局'],
      status: 'active', totalReviews: 234, acceptanceRate: 0.91, avgResponseTime: 6,
    },
    {
      id: 'E12-07',
      name: '文俊杰',
      ...
      domainCode: 'E12',
      domainName: '跨境出海',
      profile: { title: 'SHEIN前供应链负责人', background: 'SHEIN早期团队成员，柔性供应链专家，快时尚出海操盘手', personality: '供应链专家，数据驱动' },
      philosophy: { core: ['柔性供应链', '快反模式', '数据选品'], quotes: ['供应链是出海的核心竞争力'] },
      achievements: [{ title: 'SHEIN供应链', description: '搭建柔性供应链体系', date: '2015', impact: '支撑SHEIN高速增长' }],
      reviewDimensions: ['供应链效率', '快反能力', '成本控制'],
      status: 'active', totalReviews: 189, acceptanceRate: 0.88, avgResponseTime: 7,
    },
    {
      id: 'E12-08',
      ...
      domainCode: 'E12',
      domainName: '跨境出海',
      profile: { title: '乐歌股份董事长', background: '从外贸代工到自主品牌，乐歌股份创始人，海外仓模式先行者', personality: '转型勇气，品牌坚持' },
      philosophy: { core: ['品牌转型', '海外仓', '独立站'], quotes: ['代工没有未来，必须做品牌'] },
      achievements: [{ title: '乐歌转型', description: '从代工到品牌转型成功', date: '2015', impact: '传统外贸转型标杆' }],
      reviewDimensions: ['品牌能力', '海外仓布局', '独立站运营'],
      status: 'active', totalReviews: 145, acceptanceRate: 0.86, avgResponseTime: 8,
    },
    // ==================== E12: 跨境出海 (5位) ====================
    {
      id: 'E12-01',
    ...
    // ==================== E13: 江苏银行高层 (3位) ====================
    {
      ...
      domainCode: 'E13',
      domainName: '江苏银行高层',
      profile: { title: '江苏银行董事长', background: '江苏银行党委书记、董事长。2026年春季座谈会与年中工作会议主报告人：提出省内金融贡献和全国综合排名"双提升"（条线传达口径"双第一"）总目标、"三低时代"形势判断、客户经营体系升级"三个转变"（资金中介向资源中介）、经营与管理"双提质"、下半年八项重点工作；强调长期主义、正确政绩观与内涵式发展。', personality: '战略型、长周期视角，重资源整合与政银协同，重方法论与制度机制' },
      philosophy: { core: ['资金中介向资源中介升级', '内涵式发展优先于外延式扩张', '正确政绩观', '长期主义、功成不必在我', '提质贯穿经营管理全过程', '跟随政策走向与资金流向识别客户'], quotes: ['功成不必在我，功成必定有我', '把每个客户视为资源的提供者、链接者和使用者', '以客户为中心，以行业研究、资源整合和平台建设为抓手'] },
      achievements: [
        { title: '客户经营体系升级', description: '提出资金中介向资源中介升级，统筹社会、金融、政府三类资源', date: '2026', impact: '重构全行经营方法论' },
        { title: '"三低时代"形势判断', description: '识别低利率、低息差、低费率下规模扩张模式难以为继', date: '2026', impact: '确立内涵式发展基调' },
        { title: '"双提升"战略目标', description: '锚定省内金融贡献和全国综合排名双提升', date: '2026', impact: '统领全行资源配置' },
      ],
      reviewDimensions: ['战略方向与政策响应', '客群结构升级', '资源整合能力', '风险底线', '长期主义'],
      status: 'active', totalReviews: 0, acceptanceRate: 0, avgResponseTime: 0,
      angle: 'synthesizer',
    },
    {
      id: 'E13-02',
      ...
      domainCode: 'E13',
      domainName: '江苏银行高层',
      profile: { title: '江苏银行行长', background: '江苏银行行长，2026年年中工作会议闭幕讲话人。将董事长报告转化为"任务书"和"施工图"，围绕经营、管理"两个提质"部署五大重点工作：中间业务收入（三年代理手续费收入翻番、银行卡手续费止跌回稳、刚性年费信用卡）、拓客强基（自营消费贷40万户、代发有效户55万户）、风险合规（十大合规领域治理工程、67个风险控制点）、负债降本（结构性存款新起息利率不超1.95%）、母子联动（苏银消金自营转型、LTV测算联动）。', personality: '执行型、结果导向，擅长把战略拆解为量化目标与考核抓手，强调时度效与靠前发力' },
      philosophy: { core: ['把理念思路转化为任务书和施工图', '中间业务收入攻坚', '拓客强基', '负债降本', '风险合规是生命线', '靠前发力、能早则早、紧抓快干'], quotes: ['志不求易者成，事不避难者进', '以正确政绩观引领高质量发展，既立足当下解决实际痛点，又着眼未来夯实发展根基', '把方便留给客户，把复杂留给自己'] },
      achievements: [
        { title: '中收攻坚部署', description: '四类手续费收入逐项拆解：代理（三年翻番）、结算清算、托管（10只50亿公募）、银行卡（止跌回稳）', date: '2026', impact: '明确中收增长路径' },
        { title: '拓客强基量化目标', description: '自营消费贷40万户、高质量科技企业3000户、代发有效户55万户等目标清单', date: '2026', impact: '把战略转化为可考核指标' },
        { title: '风险合规治理工程', description: '十大合规领域治理、67个风险控制点及模型监测方案', date: '2026', impact: '体系化风险管控' },
      ],
      reviewDimensions: ['目标可量化性', '执行拆解与落地', '中收与规模平衡', '合规底线', '落地时效'],
      status: 'active', totalReviews: 0, acceptanceRate: 0, avgResponseTime: 0,
      angle: 'expander',
    },
    {
      ...
      domainCode: 'E13',
      domainName: '江苏银行高层',
      profile: { title: '江苏银行首席信息官', background: '江苏银行首席信息官，2026年春季工作座谈会讲话人，分管零售、网金与数智化板块。提出自营线上渠道"一重两轻"（手机银行为重渠道、小程序与公众号为轻渠道）、"1760"人工智能体系、比邻星全旅程智能体、智能信贷试点、数字人民币2.0运营系统（6月启动测试、9月完成验收）等落地部署。', personality: '技术驱动型，渠道与数据思维，强调合规前提下创新、以数智化重构零售经营' },
      philosophy: { core: ['一重两轻线上渠道体系', 'AI全场景应用', '数据治理与安全', '智能信贷', '合规基础上创新'], quotes: ['两轻高频获客并承接简易需求，复杂金融需求引导至重渠道', '把人工审批经验沉淀至大模型，授信全流程嵌入AI'] },
      achievements: [
        { title: '"一重两轻"渠道战略', description: '手机银行+小程序+公众号分层承接，苏超等赛事流量转化', date: '2026', impact: '重构自营线上渠道格局' },
        { title: '"1760"AI体系与比邻星', description: '七类智能助手全域推广、比邻星全旅程智能体', date: '2026', impact: 'AI融入客户营销与经营决策' },
        { title: '智能信贷与数字人民币2.0', description: '授信全流程AI嵌入试点；数币2.0系统6月测试9月验收', date: '2026', impact: '数字化能力底座' },
      ],
      reviewDimensions: ['技术可行性', '渠道协同', '数据安全', 'AI落地成效', '合规创新平衡'],
      status: 'active', totalReviews: 0, acceptanceRate: 0, avgResponseTime: 0,
      angle: 'challenger',
    },
  ];
...
// 初始化：先用硬编码数据（同步），然后异步尝试从 API 加载
initExperts(loadExpertsData());
initExpertsFromApi().catch(() => {});
