...
const MOCK_READER_PERSONAS: Expert[] = [
  ...
  { id: 'reader_03', name: '行业新人', code: 'reader_03', title: '应届毕业生', domain: '职场入门', domainCode: 'career', domainName: '职场入门', status: 'active', angle: 'reader', bio: '行业知识有限，需要更多背景信息和解释', level: 'junior', profile: { title: '应届毕业生', background: '职场入门', personality: '学习导向' }, philosophy: { core: [], quotes: [] }, achievements: [], reviewDimensions: [], totalReviews: 0, acceptanceRate: 0, avgResponseTime: 0 },
  ...
  { id: 'reader_05', name: '资深从业者', code: 'reader_05', title: '行业老兵', domain: '行业深度', domainCode: 'industry', domainName: '行业深度', status: 'active', angle: 'reader', bio: '行业经验丰富，对内容质量要求高，追求独到见解', level: 'expert', profile: { title: '行业老兵', background: '行业深度', personality: '经验丰富' }, philosophy: { core: [], quotes: [] }, achievements: [], reviewDimensions: [], totalReviews: 0, acceptanceRate: 0, avgResponseTime: 0 },
  ...
  { id: 'reader_07', name: '跨界学习者', code: 'reader_07', title: '多领域关注者', domain: '跨界创新', domainCode: 'crossover', domainName: '跨界创新', status: 'active', angle: 'reader', bio: '喜欢跨领域学习，需要通俗易懂的解释', level: 'junior', profile: { title: '多领域关注者', background: '跨界创新', personality: '好奇探索' }, philosophy: { core: [], quotes: [] }, achievements: [], reviewDimensions: [], totalReviews: 0, acceptanceRate: 0, avgResponseTime: 0 },
  ...
  { id: 'reader_10', name: '故事爱好者', code: 'reader_10', title: '叙事偏好读者', domain: '人文故事', domainCode: 'humanities', domainName: '人文故事', status: 'active', angle: 'reader', bio: '通过故事理解世界，喜欢有人情味的内容', level: 'junior', profile: { title: '叙事偏好读者', background: '人文故事', personality: '感性理解' }, philosophy: { core: [], quotes: [] }, achievements: [], reviewDimensions: [], totalReviews: 0, acceptanceRate: 0, avgResponseTime: 0 },
];
