  ...
  apps: [
    {
      ...
      env: {
        ...
        PUBLIC_API_BASE_URL: process.env.PUBLIC_API_BASE_URL || 'http://paper.morning.rocks',
        API_BASE_URL: process.env.API_BASE_URL || 'http://paper.morning.rocks',
        PUBLIC_BASE_URL: process.env.PUBLIC_BASE_URL || 'http://paper.morning.rocks',
