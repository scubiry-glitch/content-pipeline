...
export const SYNONYMS: Array<{ tokens: string[]; code: string }> = [
  ...
  { tokens: ['AI 应用', 'AI应用', 'AIGC'], code: 'E07.APP' },
  ...
  // E02 — Finance
  { tokens: ['银行', '支付', 'Fintech'], code: 'E02.BANK' },
  { tokens: ['保险'], code: 'E02.INSUR' },
  { tokens: ['资管', '资产管理', '基金'], code: 'E02.ASSET' },
  { tokens: ['加密', '数字资产', 'Crypto', 'Web3'], code: 'E02.CRYPTO' },
  { tokens: ['金融监管'], code: 'E02.REG' },
  { tokens: ['金融基础设施', '清算', '交易所'], code: 'E02.INFRA' },
  ...
  { tokens: ['REITs', 'REIT', '不动产金融'], code: 'E08.REIT' },
  { tokens: ['租赁', '长租'], code: 'E08.RENT' },
