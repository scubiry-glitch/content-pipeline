...
import { FEW_SHOT_HEADER, EX_MEETING_NECESSITY } from '../_examples.js';
...
- ratio 是该理由占会议时长的估计；ratio 之和应接近 1
- 每条 reason.t 必须给具体内容（哪段/谁/什么议题），不要"部分讨论可以异步"

${FEW_SHOT_HEADER}
${EX_MEETING_NECESSITY}`;
