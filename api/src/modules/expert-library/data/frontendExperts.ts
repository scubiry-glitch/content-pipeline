// Auto-generated: frontend expert display data
// Source: webapp/src/services/expertService.ts loadExpertsData()

export const frontendExpertsData: any[] = [
    // ==================== 10位特级专家 ====================
    {
      id: 'S-01',
      name: '张一鸣',
...
// ==================== E13: 江苏银行高层 (3位) ====================
    ...
    // ==================== E14: 宏观经济与房地产制度 (1位) ====================
    {
      ...
      level: 'domain',
      domainCode: 'E14',
      domainName: '宏观经济与房地产制度',
      profile: { title: '国务院发展研究中心原副主任·第十三届全国政协经济委员会副主任', background: '第十三届全国政协经济委员会副主任、国务院发展研究中心原副主任、中国发展研究基金会副理事长。"博智宏观论坛"发起人之一，长期从事发展经济学、产业经济、宏观经济研究。其团队最早（约2010年前后）提出"中国房地产历史需求峰值已过"判断，以"增长阶段转换论""支柱产业不等于必须保增长论""结构性错配论"著称：认为消费占GDP比重较全球平均低约20个百分点属结构性偏差，扩内需重点是近3亿农民工基本公共服务均等化；提出收购滞销住房转保障房、设立"中储房"储备项目等政策路径；2026年研判房地产增速大概率回稳至4%-5%，不会崩盘，但回升是"结构性的、个别的、点状的"，需系统性"房地产发展新政"。', personality: '制度主义与结构性思维，重中长期改革而非短期刺激；直言不讳、敢于逆共识（"小心伺候""支柱产业也可以负增长"）；坚持从真实世界问题出发，主张从脚出发去选鞋' },
      philosophy: { core: ['中国房地产历史需求峰值已过，增长阶段转换', '支柱产业不等于必须保增长，回落符合规律', '总量过剩与结构性不足并存（结构性错配论）', '稳消费先稳房地产', '消费占GDP比重低全球约20个百分点是结构性偏差', '以农民工为主的新市民基本公共服务均等化是扩内需主抓手', '房地产从增量市场转向存量市场，政策逻辑必须转变', '收购滞销住房转保障房、"中储房"储备机制', '大都市圈外中小城镇是第二轮城市化空间'], quotes: ['中国房地产高速增长的时代已经结束了', '中高收入阶层要住"好房子"，"锦上添花"可以，但更重要的是"雪中送炭"', '外卖小哥在农村有一个二层小楼……实际使用率不到5%。这不是个例，是一个巨大社会群体的现状', '支柱产业也可以是低速增长，甚至负增长，一定不要以为支柱产业，政府一定要保', '中国还有5亿人没用上马桶，10亿人没坐过飞机', '小心伺候，使它缓慢平稳地回落下来', '有些改革措施今天晚上发布了以后，明天整个社会的影响比降息的作用要大得多'] },
      achievements: [
        { title: '"历史需求峰值已过"判断', description: '团队约2010年前后最早提出中国房地产历史需求峰值已过；2016年博智宏观论坛以微观数据论证一线房价上涨源于供求关系紧张', date: '2016', impact: '奠定中国房地产中长期研判基调' },
        { title: '"中储房"与存量转保障房', description: '2025年提出收购滞销住房转为保障性住房，可探讨设立"中储房"储备项目（类比中储粮），应对区域差异、提供全国性金融服务', date: '2025', impact: '存量消化与保障房供给结合的政策路径' },
        { title: '增长阶段转换与结构性偏差', description: '中国经济从高速转向中速、由供给约束转向需求约束；消费占GDP比重较全球平均低约20个百分点是"结构性偏差"，须以基本公共服务均等化补缺口', date: '2026', impact: '确立"稳消费先稳房地产"的宏观分析框架' },
      ],
      reviewDimensions: ['结构性判断与长期趋势', '政策与制度改革取向', '民生与保障视角', '宏观约束与可行性', '存量市场逻辑'],
      status: 'active', totalReviews: 0, acceptanceRate: 0, avgResponseTime: 0,
      angle: 'structuralist',
    },
  ];
